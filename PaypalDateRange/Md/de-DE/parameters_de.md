...
glossaries:
  - name: App-Gruppe REST API-Schlüssel
    ...
    field: "api_key"
  - name: App-Kennung
    description: Wenn Sie Push an eine Reihe von Gerätetokens senden möchten (anstelle von Benutzern), müssen Sie angeben, für welche bestimmte App Sie Nachrichten senden. In diesem Fall geben Sie die entsprechende App-ID in einem Token-Objekt ein. Sie finden sie im Abschnitt „<strong>Developer Console</strong>“ des Braze-Dashboards.
    field: "app_id"
